...
import { 
  ...
  FaRegSmile, FaRegClock, FaChartLine
} from 'react-icons/fa';
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            ...
            >
              ...
              <div className="hidden sm:flex flex-col min-w-0">
                ...
                <span className="text-xs sm:text-sm text-gray-600 truncate">Intern Records</span>
              </div>
            </motion.div>
          </div>
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-600">{intern?.traineeName} - {intern?.traineeId}</p>
                </div>
              </div>
              <motion.div 
              ...
              >
                ...
                <p className="text-xl sm:text-2xl font-bold text-cyan-600">{internDetails?.records?.length || 0}</p>
              </motion.div>
            </motion.div>
              ...
              <div className="flex flex-col space-y-3 sm:space-y-4 xl:flex-row xl:space-y-0 xl:space-x-4">
                ...
                <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                  ...
                  >
                    ...
                    >
                      <option value="all" className="bg-white">All Time</option>
                      <option value="week" className="bg-white">Last Week</option>
                      <option value="month" className="bg-white">Last Month</option>
                      <option value="3months" className="bg-white">Last 3 Months</option>
                    </select>
                  </motion.div>
                  ...
                  >
                    ...
                    <select
                      ...
                      className="px-3 py-1.5 text-sm sm:text-base bg-transparent border-0 focus:ring-0 focus:outline-none text-gray-900 flex-1 sm:flex-none"
                    >
                      <option value="date" className="bg-white">Newest First</option>
                      <option value="dateOld" className="bg-white">Oldest First</option>
                    </select>
                  </motion.div>
                </div>
              </div>
              ...
              <AnimatePresence>
                {filteredRecords.length === 0 ? (
                  ...
                  >
                    ...
                    <h3 className="text-base sm:text-lg font-medium text-gray-700 mb-2">No records found</h3>
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        {record.task && (
                          ...
                          >
                            ...
                            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{record.task}</p>
                          </motion.div>
                        )}
                        ...
                        {record.progress && record.progress !== "No challenges faced" && (
                          ...
                          >
                            ...
                            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{record.progress}</p>
                          </motion.div>
                        )}
                        ...
                        {record.blockers && record.blockers !== "No specific plans" && (
                          ...
                          >
                            ...
                            <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">{record.blockers}</p>
                          </motion.div>
                        )}
                      </div>
