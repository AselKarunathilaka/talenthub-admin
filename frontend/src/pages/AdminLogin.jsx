          ...
          <div className="w-full max-w-sm lg:max-w-md py-2">
            ...
            >
              ...
              <p className="text-white/60 mt-1 text-xs sm:text-sm leading-relaxed max-w-sm mx-auto">
                Sign in with your administrator credentials to manage interns.
              </p>
            </motion.div>
            </div>
                ...
                <div className="flex-1 flex flex-col justify-center my-1">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-1 sm:space-y-1.5 mb-2 sm:mb-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3.5 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-bold transition-all duration-300 cursor-pointer disabled:opacity-50 mt-2.5"
                      style={{
                        background: "#ffffff",
                        color: "#3c3c3c",
