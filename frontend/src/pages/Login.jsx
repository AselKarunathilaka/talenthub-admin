            ...
            >
              ...
              <div className="p-4 sm:p-5 flex flex-col h-full justify-between">
                ...
                <div className="flex-1 flex flex-col justify-center my-1">
                  {/* Google Login Button */}
                  <div className="flex justify-center scale-100 sm:scale-105 origin-center">
                    {isLoading ? (
                      <div className="inline-flex items-center px-5 py-2 rounded-full bg-white/5 border border-white/10">
                        <div className="w-4 h-4 border-t-2 border-b-2 border-[#00b4eb] rounded-full animate-spin mr-2.5" />
