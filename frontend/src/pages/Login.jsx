    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-full lg:w-[48%] xl:w-[46%] flex items-center justify-center min-h-screen lg:min-h-0 py-6 px-4 sm:p-6 lg:py-8 lg:px-8"
        >
          <div className="w-full max-w-sm lg:max-w-md py-2">
              ...
              <div className="p-5 sm:p-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 px-3.5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 cursor-pointer disabled:opacity-50"
                    style={{
            ...
            <motion.div
              ...
              className="text-center text-white/30 text-[11px] sm:text-xs pt-3 sm:pt-4"
            >
          ...
          >
            ...
            >
              ...
              <p className="text-white/50 text-[11px] xl:text-xs max-w-sm mx-auto leading-relaxed">
                Comprehensive platform for attendance, Seat Reservation, tasks, daily progress
                tracking and more.
              </p>
            </motion.div>
