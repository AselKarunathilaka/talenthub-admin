...
import { FiFileText, FiCalendar, FiClock, FiUser, FiTrash2, FiPlus, FiX, FiEye } from 'react-icons/fi';
...
const MyLeaveRequests = () => {
  ...
  console.log('[MyLeaveRequests] Rendering component. Loading:', loading, 'Requests:', leaveRequests.length, 'ShowForm:', showForm);
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-sm text-gray-900">{request.purpose}</span>
                      </div>

                      <div className="flex items-start gap-2">
                        <span className="text-sm font-medium text-gray-700 min-w-[100px]">Reason:</span>
                        <span className="text-sm text-gray-900">{request.reason}</span>
                      </div>

                      {request.proofDocument && request.proofDocument.data && (
                        <div className="flex items-start gap-2">
                          <span className="text-sm font-medium text-gray-700 min-w-[100px]">Proof:</span>
                          <button
                      ...
                      {request.adminResponse && (
                        <div className="mt-4 p-3 bg-gray-50 rounded-lg border-l-4 border-blue-600">
                          <span className="text-sm font-medium text-gray-700 block mb-1">Admin Response:</span>
                          <span className="text-sm text-gray-900">{request.adminResponse}</span>
                        </div>
                      )}
